...
module.exports = class extends Task
  ...
  execute: ->
    ...
    .then (ids) -> @AtBats.update {game_id: {$nin: ids}, active: true}, {$set: {active: false}}, {multi: true}
    .tap (result) -> @logger.verbose result, "#{result.nModified} atBat(s) have been closed as inactive"
